...
function stringCounter(string) {
  ...
  var avgWordCount = ((charCount - spaceCount) / wordCount); // Set average word count to (charachter count - space count) divided by amount of words
  return {
    'words': wordCount,
    'characters': charCount,
    'chars avg word length': avgWordCount,
    'spaces': spaceCount
  }
} 
